...
echo "$(date): Starting DRC using Magic /home/mrg/data/sky130_fd_bd_sram/env/conda/envs/sky130_fd_bd_sram/bin/magic"
...
EOF
magic_retcode=$?
echo "$(date): Finished ($magic_retcode) DRC using Magic /home/mrg/data/sky130_fd_bd_sram/env/conda/envs/sky130_fd_bd_sram/bin/magic"
exit $magic_retcode
