...
echo "$(date): Starting LVS using Netgen /home/mrg/data/skywater-tech/env/conda/envs/sky130_fd_bd_sram/bin/netgen"
/home/mrg/data/skywater-tech/env/conda/envs/sky130_fd_bd_sram/bin/netgen -noconsole << EOF
...
EOF
magic_retcode=$?
echo "$(date): Finished ($magic_retcode) LVS using Netgen /home/mrg/data/skywater-tech/env/conda/envs/sky130_fd_bd_sram/bin/netgen"
exit $magic_retcode
